...
\begin{tikzpicture}[]
    ...
    \draw[-{Latex[length=2mm,width=3mm]},violet] ($(cn)!0.55!(cn_ground)$) -- node[above,sloped]{MN locator update}  ($(r)!0.75!(r_ground)$);
    \draw[-{Latex[length=2mm,width=3mm]},violet] ($(r)!0.75!(r_ground)$) -- node[above,sloped]{MN locator update}  ($(mnb)!0.95!(mnb_ground)$);
